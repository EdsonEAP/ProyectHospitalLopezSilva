...
class TerminosRegister extends StatefulWidget {
  static const String name = "TerminosRegister";

  const TerminosRegister({Key? key}) : super(key: key);

  @override
  _TerminosRegisterState createState() => _TerminosRegisterState();
}

class _TerminosRegisterState extends State<TerminosRegister> {
